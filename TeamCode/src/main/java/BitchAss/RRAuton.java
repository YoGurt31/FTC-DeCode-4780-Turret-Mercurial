...
//            Action shootStart = RRAuton.shootArtifactsAction(drive, Constants.Field.Alliance.BLUE);
//
...
//                    .build();
//
//            Action shootAgain = RRAuton.shootArtifactsAction(drive, Constants.Field.Alliance.BLUE);
//
//            return new SequenceAction(
//                    shootStart,
//                    driveAndIntake,
