...
public class TeleOpBlue extends OpMode {
    ...
    private static final int BLUE_TARGET_ID = 20;
    ...
    private double aimbotRotate() {
        Double tx = VisionSystem.getTxIfSeeing(BLUE_TARGET_ID);
    ...
    public void init() {
        ...
        VisionSystem.setPipeline(vision.BLUE);
        ...
        driveCommand = DriveCommands.teleOpDrive(
                ...
                () -> {
                    if (aimbotActive() && VisionSystem.seesFiducialId(BLUE_TARGET_ID)) {
                        return aimbotRotate();
                    }
        ...
        Mercurial.gamepad1().x()
                .whileTrue(new Lambda("HoldLeftGateBlue")
        ...
        Mercurial.gamepad1().b()
                .whileTrue(new Lambda("HoldRightGateBlue")
                        .addRequirements(outtake)
                        .setExecute(() -> {
                            spinFlywheelToFar();
                            double rps = avgFlywheelRps();
