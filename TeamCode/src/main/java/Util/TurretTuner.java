                ...
                loop(exec(() -> {
                    ...
                    switch (mode[0]) {
                        case TURRET: {
                            ...
                            if (rising(linsane.gamepad1().right_stick_button, prevRS)) turretPrecise[0] = !turretPrecise[0];
                            ...
                            linsane.telemetry().addLine("R3 toggle Quick/Precise | L3 click toggle Alliance | LB/RB cycle param | Dpad L/R step | Dpad U/D adjust");
                            ...
                            linsane.telemetry().addData("YawSource", turretPrecise[0] ? "APRILTAG-CENTER" : "(not used)");
                    ...
                    linsane.telemetry().addData("Mode", "TURRET");
